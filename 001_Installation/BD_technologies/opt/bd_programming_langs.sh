...
touch /home/frederick/.bash_profile.sh

echo "JAVA_HOME=/home/frederick/opt/jdk1.8.0_221" >> /home/frederick/.bash_profile.sh
...
echo "PYTHON_HOME=/home/frederick/opt/Python-3.7.7" >> /home/frederick/.bash_profile.sh
echo "export PATH=$PATH:$PYTHON_HOME/bin" >> /home/frederick/.bash_profile.sh
...
echo "SCALA_HOME=/home/frederick/opt/scala-2.11.8" >> /home/frederick/.bash_profile.sh
echo "export PATH=$PATH:$SCALA_HOME/bin" >> /home/frederick/.bash_profile.sh
...
echo "SBT_HOME=/home/frederick/opt/sbt-1.3.13" >> /home/frederick/.bash_profile.sh
echo "export PATH=$PATH:$SBT_HOME/bin" >> /home/frederick/.bash_profile.sh
